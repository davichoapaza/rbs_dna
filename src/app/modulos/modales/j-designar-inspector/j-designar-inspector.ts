...
export class JDesignarInspector implements OnInit {
  private fb = inject(FormBuilder);
  public dialogRef = inject(MatDialogRef<JDesignarInspector>);
  ...
  notificarEIniciar(): void {
    console.log('Notificar e Iniciar Inspección:', this.formularioAsignacion.value);
